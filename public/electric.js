...
class Buffer {
  ...
  loaded() {
    ...
    document.querySelector(".notess").style.height = "auto";
    document.querySelector(".notess").style.opacity = 1;
    loaded = true;
  }
...
let buttons = document.querySelectorAll(".notess .note");
...
let circle = document.querySelector(".circlee");
